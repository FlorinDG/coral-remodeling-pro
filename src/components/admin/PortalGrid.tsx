    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {portals.map(portal => (
                    <div key={portal.id} className="group glass-morphism p-6 rounded-2xl border border-neutral-200 dark:border-white/5 hover:border-[#d35400]/50 transition-all relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity">
                            <Link href={`/admin/portals/${portal.id}`} className="p-2 bg-neutral-900 dark:bg-white text-white dark:text-black rounded-full hover:bg-[#d35400] dark:hover:bg-neutral-200 block transition-colors">
                        ...
                        <div className="flex justify-between items-end">
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="text-[10px] font-mono text-neutral-400 dark:text-neutral-500 hover:text-[#d35400] uppercase tracking-widest"
                            >
                                /{portal.slug}
                            </Link>
                        </div>
