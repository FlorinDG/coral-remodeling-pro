        ...
        emails: [
            {
                ...
                recipientId: 2,
                subject: "Finalizing the Kitchen Remodel Proposal",
                snippet: "Hi team, I've reviewed the latest 3D renders for the Smith kitchen project.",
                isRead: true,
        ...
        emails: [
            {
                ...
                recipientId: 1,
                subject: "Invoice #INV-2024-089 - Payment Received",
                snippet: "Hello, Just confirming that we have received the initial deposit for the hardwood flooring.",
                isRead: true,
        ...
        emails: [
            {
                ...
                recipientId: 1,
                subject: "New Lead: Full Home Renovation (Antwerp)",
                snippet: "Hi, A new lead just came in through the website contact form.",
                isRead: false,
