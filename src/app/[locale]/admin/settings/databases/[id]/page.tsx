            ...
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div className="divide-y divide-neutral-100 dark:divide-white/5">
                    {database.properties.map(prop => {
                        ...
                        return (
                            <div key={prop.id} className="p-4 hover:bg-neutral-50 dark:hover:bg-white/[0.02] transition-colors flex flex-col md:flex-row md:items-center gap-4">
                                    ...
                                    {prop.type === 'relation' && (
                                        <div className="flex flex-col gap-1 flex-1 min-w-[200px]">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => updateProperty(databaseId, prop.id, { config: { ...prop.config, relationDatabaseId: e.target.value } })}
                                                className="w-full bg-white dark:bg-black border border-neutral-300 dark:border-white/20 rounded-lg px-2 py-1.5 text-sm outline-none focus:ring-2 focus:ring-blue-500"
                                            >
                                    ...
                                    {prop.type === 'formula' && (
                                        <div className="flex flex-col gap-1 flex-1 min-w-[200px]">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => updateProperty(databaseId, prop.id, { config: { ...prop.config, formulaExpression: e.target.value } })}
                                                className="w-full font-mono bg-white dark:bg-black border border-neutral-300 dark:border-white/20 rounded-lg px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-neutral-300 dark:placeholder:text-neutral-700"
                                            />
                                        </div>
                                    )}
                                </div>
