    ...
    return (
        <div className="flex flex-col w-full h-full">
            ...
            <div className="w-full h-full p-6 pb-10 flex flex-col items-center justify-center text-neutral-500">
                ...
                <h2 className="text-xl font-medium tracking-tight">HR Settings Configuration</h2>
                <p className="mt-2 text-sm max-w-md text-center">This section will house all administrative configurations for the hr module.</p>
            </div>
        </div>
    );
}
