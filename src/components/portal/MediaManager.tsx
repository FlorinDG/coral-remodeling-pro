    ...
    return (
        <div className="bg-neutral-50 dark:bg-white/5 rounded-[2.5rem] border border-neutral-200 dark:border-white/10 p-8 shadow-sm">
            <div className="flex justify-between items-center mb-6">
                ...
                {!readOnly && !isAdding && (
                    <button
                        ...
                        className="px-4 py-2 bg-[#d35400] text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-neutral-900 transition-all shadow-lg shadow-[#d35400]/20"
                    >
                        Add Media
                    </button>
                )}
            ...
            <div className="space-y-4">
                {isAdding && (
                    <div className="glass-morphism p-6 rounded-3xl border border-[#d35400]/20 animate-in zoom-in-95 duration-200 mb-6 font-bold">
                        <div className="flex justify-between items-center mb-4">
                            <span className="text-[10px] font-black uppercase tracking-widest text-[#d35400]">New Image</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
                    ...
                    {media.map((item) => (
                        <div key={item.id} className="group relative aspect-[2/1] rounded-2xl overflow-hidden border border-neutral-200 dark:border-white/5 bg-white dark:bg-black/40 shadow-sm hover:shadow-xl hover:shadow-[#d35400]/5 hover:-translate-y-1 transition-all duration-300">
                            <img
                                src={item.url}
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                                ...
                                <a
                                    href={item.url}
                                    target="_blank"
                                    className="bg-[#d35400] text-white p-2 rounded-lg self-end hover:bg-white hover:text-[#d35400] transition-colors"
                                >
