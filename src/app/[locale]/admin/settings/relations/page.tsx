            ...
            <div className="flex-1 overflow-y-auto p-6 pb-16 bg-neutral-50/50 dark:bg-[#0a0a0a]">
                <div className="max-w-2xl">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-neutral-900 dark:text-white">Relations Settings</h1>
                            <p className="text-xs text-neutral-500">CRM & contact management defaults.</p>
                        </div>
                    </div>
