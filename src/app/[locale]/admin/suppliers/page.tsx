...
const DatabaseCloneDynamic = dynamic(
    ...
    { ssr: false, loading: () => <div className="flex h-[calc(100vh-8rem)] items-center justify-center text-neutral-500">Preparing Suppliers Database...</div> }
);
...
export default function SuppliersPage() {
    ...
    return (
        <div className="flex flex-col w-full h-full">
            <ModuleTabs tabs={suppliersTabs} groupId="suppliers" />
