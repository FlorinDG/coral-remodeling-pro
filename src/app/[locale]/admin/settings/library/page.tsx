                ...
                <div className="max-w-2xl">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-10 h-10 rounded-xl bg-neutral-100 dark:bg-white/10 flex items-center justify-center">
                            <Library className="w-5 h-5 text-neutral-600 dark:text-neutral-400" />
                        </div>
                        <div>
                            <h1 className="text-xl font-bold text-neutral-900 dark:text-white">Library Settings</h1>
                            <p className="text-xs text-neutral-500">Article library and unit defaults.</p>
                        </div>
                    </div>
