        ...
        <main className="min-h-screen bg-white text-neutral-900 dark:bg-black dark:text-white pt-10">
            ...
            <div className="relative h-[60vh] w-full">
                ...
                <div className="absolute bottom-0 left-0 p-8 md:p-16 w-full max-w-[95vw] 2xl:max-w-7xl">
                    ...
                    <h1 className="text-[42px] md:text-[66px] lg:text-[72px] leading-tight font-bold mb-6 text-neutral-900 dark:text-white lg:whitespace-nowrap tracking-tight">{service.title}</h1>
                </div>
            </div>
