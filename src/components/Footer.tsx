...
export default function Footer() {
    ...
    return (
        <footer id="contact" className="bg-neutral-950 text-white pt-24 pb-12 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#d75d00]/5 rounded-full blur-[120px] -mr-64 -mt-64 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#d75d00]/5 rounded-full blur-[100px] -ml-48 -mb-48 pointer-events-none" />
            ...
            <div className="container mx-auto px-8 md:px-16 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10">
                                <Logo className="w-full h-full text-[#d75d00]" />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-xl font-bold tracking-tighter uppercase italic leading-none">
                                    Coral <span className="text-[#d75d00]">Enterprises</span>
                                </span>
                                <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#d75d00] mt-1">
                                    Luxury. Redefined.
                                </span>
                            </div>
                        </div>
                    ...
                    {/* Quick Links Column */}
                    <div className="space-y-6">
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#d75d00]">
                            {t('quickLinks')}
                        </h4>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li>
                                <a href="tel:+32472741025" className="flex items-center gap-3 text-neutral-300 hover:text-white transition-colors group">
                                    <Phone className="w-4 h-4 text-[#d75d00]" />
                            ...
                            <li>
                                <a href="https://wa.me/32472741025" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-neutral-300 hover:text-white transition-colors">
                                    <MessageCircle className="w-4 h-4 text-[#d75d00]" />
                                    <span>WhatsApp</span>
                                </a>
                            </li>
                            <li>
                                <a href="mailto:info@coral-group.be" className="flex items-center gap-3 text-neutral-300 hover:text-white transition-colors">
                                    <Mail className="w-4 h-4 text-[#d75d00]" />
                                    <span>Email Us</span>
                                </a>
                            </li>
                            <li className="pt-2">
                                <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-2">
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-[#d75d00]">
                                        {t('fastInterventions')}
                                    </p>
                                    <a href="tel:+32472741025" className="text-lg font-bold tracking-tighter hover:text-[#d75d00] transition-colors">
                                        +32 472 74 10 25
                                    </a>
                                </div>
                            </li>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 text-sm text-neutral-300">
                            <li className="flex items-start gap-3">
                                <MapPin className="w-4 h-4 mt-0.5 text-[#d75d00]" />
                                <span>{t('address')}</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Building className="w-4 h-4 text-[#d75d00]" />
                                <span>VAT: {t('vat')}</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <ShieldCheck className="w-4 h-4 text-[#d75d00]" />
