...
const T = {
    nl: {
        tagline: 'Belgische e-facturatie · Verplicht sinds 2026',
        heroTitle1: 'Het',
        ...
        peppolBadge: 'Peppol · Verplicht sinds 2026',
        peppolTitle: 'Volledig conform de Belgische e-facturatieplicht',
        peppolSub: 'Sinds 1 januari 2026 is e-facturatie via Peppol verplicht voor alle B2B-transacties in België. CoralOS genereert automatisch UBL-conforme facturen en verstuurt ze via het officiële netwerk — zodat jij er geen seconde aan hoeft te denken.',
        ...
        founderSub: 'De oprichtingscohort staat nog open. Registreer binnen de komende 3 maanden om een gratis FOUNDER-account te krijgen met volledige toegang, zonder Peppol-limieten — voor altijd.',
        ...
        faq: [
            ...
            { q: 'Wat is Peppol en waarom is het verplicht?', a: 'Peppol is het Europese netwerk voor gestructureerde elektronische facturatie. Sinds 1 januari 2026 is dit verplicht voor alle B2B-transacties in België.' },
            { q: 'Wat is een FOUNDER-account?', a: 'Registreer tijdens de oprichtingsperiode (nog beperkt beschikbaar) voor een FOUNDER-account: gratis, volledige toegang, geen Peppol-limieten — voor altijd.' },
    ...
    fr: {
        tagline: 'E-facturation belge · Obligatoire depuis 2026',
        ...
        peppolBadge: 'Peppol · Obligatoire depuis 2026',
        peppolTitle: 'Conforme à l\'obligation belge de e-facturation',
        peppolSub: 'Depuis le 1er janvier 2026, la facture électronique via Peppol est obligatoire pour toutes les transactions B2B en Belgique. CoralOS génère automatiquement des factures conformes UBL et les envoie via le réseau officiel.',
        ...
        founderSub: 'La cohorte fondatrice est encore ouverte. Inscrivez-vous dans les 3 prochains mois pour obtenir un compte FOUNDER gratuit avec accès complet, sans limite Peppol — pour toujours.',
        ...
        faq: [
            ...
            { q: 'Qu\'est-ce que Peppol et pourquoi est-ce obligatoire?', a: 'Peppol est le réseau européen pour la facturation électronique structurée. Depuis le 1er janvier 2026, cela est obligatoire pour toutes les transactions B2B en Belgique.' },
            { q: 'Qu\'est-ce qu\'un compte FOUNDER?', a: 'Inscrivez-vous pendant la période fondatrice (disponible pour une durée limitée) pour obtenir un compte FOUNDER : gratuit, accès complet, sans limites Peppol — pour toujours.' },
    ...
    en: {
        tagline: 'Belgian e-invoicing · Mandatory since 2026',
        heroTitle1: 'The',
        ...
        peppolBadge: 'Peppol · Mandatory since 2026',
        peppolTitle: 'Fully compliant with the Belgian e-invoicing mandate',
        peppolSub: 'Since January 1, 2026, e-invoicing via Peppol is mandatory for all B2B transactions in Belgium. CoralOS automatically generates UBL-compliant invoices and sends them via the official network.',
        ...
        founderSub: 'The founding cohort is still open. Register in the next 3 months to get a free FOUNDER account with full access and no Peppol limits — forever.',
        ...
        faq: [
            ...
            { q: 'What is Peppol and why is it mandatory?', a: 'Peppol is the European network for structured electronic invoicing. Since January 1, 2026, it is mandatory for all B2B transactions in Belgium.' },
            { q: 'What is a FOUNDER account?', a: 'Register during the founding period (open for a limited time) to get a FOUNDER account: free, full access, no Peppol limits — forever.' },
