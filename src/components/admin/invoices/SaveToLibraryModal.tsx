                    ...
                    {isEdit && (
                        <div className="flex flex-col gap-2 p-3 bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-lg">
                            ...
                            <p className="text-xs text-red-800 dark:text-red-200">
                                This action will modify the base article <strong>{existingArticle.properties?.[propMap.title] || 'Unknown'}</strong>. Any future invoices or variants using this article will pull the new values.
                            </p>
                        </div>
                    )}
