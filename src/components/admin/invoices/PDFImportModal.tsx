            ...
            <DialogContent className="sm:max-w-[700px] border-none bg-white dark:bg-[#0a0a0a] text-black dark:text-white shadow-2xl p-0 overflow-hidden">
                <DialogHeader className="p-6 pb-2">
                    ...
                    <DialogDescription className="text-sm text-neutral-500">
                        Upload a supplier invoice or invoice PDF (e.g. Facq, Desco). OpenAI will instantly extract the line items, quantities, and prices.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    {extractedItems.length > 0 && !isProcessing && (
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex justify-end mt-4 gap-3">
                                ...
                                >
                                    Import {extractedItems.length} Items to Invoice <ArrowRight className="w-4 h-4" />
                                </button>
                            </div>
                        </div>
                    )}
