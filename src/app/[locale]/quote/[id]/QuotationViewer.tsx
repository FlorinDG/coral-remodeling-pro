...
export default function QuotationViewer({ quoteId, properties, blocks }: { quoteId: string, properties: any, blocks: any }) {
    ...
    const betreft = properties?.betreft || 'Offerte';
    ...
    const handleAccept = async () => {
        ...
        const result = await acceptQuotation(quoteId, signatureBase64);
        if (result.success) {
            setIsAccepted(true);
        } else {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden">
                <div className="p-8 border-b border-neutral-100 flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-sm text-neutral-500 font-mono mt-1">REF: {quoteTitle}</p>
                    </div>
                ...
                <div className="p-8 bg-neutral-50/50 flex flex-col items-center justify-center text-center gap-4 py-16">
                    ...
                    <p className="text-neutral-500 max-w-sm">
                        De uitgebreide berekening en details van deze offerte vindt u in de originele PDF die u per e-mail is toegestuurd.
                    </p>
                </div>
            </div>
                    ...
                    {isAccepted || existingSignature ? (
                        <div className="flex flex-col items-center justify-center py-8 gap-4">
                            ...
                            <div className="text-center">
                                <h3 className="text-xl font-bold text-emerald-600 mb-1">Offerte Succesvol Geaccepteerd!</h3>
                        ...
                        <div className="flex flex-col gap-4">
                            <p className="text-sm text-neutral-600 mb-2">
                                Door hieronder te tekenen en op &quot;Offerte Accepteren&quot; te klikken, gaat u officieel akkoord met de uitvoering van het project.
                            </p>
                            ...
                            <div className="flex justify-between items-center mt-2">
                                ...
                                >
                                    {isSubmitting ? 'Bezig met verwerken...' : 'Offerte Accepteren'}
                                </button>
                            </div>
                        </div>
                    )}
