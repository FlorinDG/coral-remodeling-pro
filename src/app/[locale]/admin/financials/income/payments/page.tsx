...
const DatabaseCloneDynamic = dynamic(
    ...
    { ssr: false, loading: () => <div className="flex h-[calc(100vh-8rem)] items-center justify-center text-neutral-500">Preparing Received Payments Database...</div> }
);

export default function ReceivedPaymentsPage() {
    usePageTitle('Received Payments');
    ...
    return (
        <div className="flex flex-col w-full h-full">
            ...
            <div className="w-full flex-1 flex flex-col pt-6 min-h-0">
                <DatabaseCloneDynamic databaseId="db-payments-in" />
            </div>
        </div>
    );
}
