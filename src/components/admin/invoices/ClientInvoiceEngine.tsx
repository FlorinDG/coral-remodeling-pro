        ...
        <div className="flex flex-col w-full min-h-screen md:h-full bg-white dark:bg-black text-neutral-900 dark:text-white">
            ...
            {isHydrated && (() => {
                ...
                if (!isCreditNote && !isProforma && creditNotes.length > 0) {
                    ...
                    return (
                        <div className="bg-amber-50 dark:bg-amber-900/20 border-b border-amber-200 dark:border-amber-700/50 px-3 md:px-6 py-2.5 flex items-center justify-between shrink-0 text-xs text-amber-700 dark:text-amber-300">
                            <div className="flex items-center gap-2">
                ...
                <div className="w-full max-w-[1400px] mx-auto flex flex-col gap-1 pb-32">
                    ...
                    {(isDraft && !isLocked) && <div className="flex items-center gap-2 mt-2">
                        ...
                        <button
                            ...
                            className="text-xs font-semibold flex items-center gap-1.5 transition-colors py-1.5 px-3 rounded-lg shadow-sm border text-neutral-600 dark:text-neutral-300 border-neutral-200 dark:border-white/10 hover:bg-neutral-100 dark:hover:bg-white/5"
                        >
